...
var walkDataBookmarksTurns = [NumOfNodes]int{
	91, 145, 260, 314, 405, 471,
}

var walkDataStartHeadings = [NumOfNodes][NumOfNodes]int{
	//   A   B   C   D   E   F
	{-1, 6, 6, -1, 5, 5},   // A
	{3, -1, 5, -1, -1, -1}, // B
	{2, 1, -1, 3, 2, 2},    // C
...
var walkDataEndHeadings = [NumOfNodes][NumOfNodes]int{
	//   A   B   C   D   E   F
	{-1, 7, 5, -1, 5, 5},   // A
	{3, -1, 5, -1, -1, -1}, // B
	{2, 1, -1, 4, 3, 3},    // C
